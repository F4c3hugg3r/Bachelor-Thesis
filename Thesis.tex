...
\datum{14.02.2025}   	% Abgabedatum der Arbeit
%% Typ der Arbeit
...
\input{chapter/03_Stand_der_Technik.tex}
\input{chapter/04_Methodik_Anforderungsanalyse.tex}
\input{chapter/05_Konzeption_Implementierung.tex}
\input{chapter/06_Testumgebung.tex}
...
\input{chapter/101_KI_Verzeichnis.tex} \clearpage

...
% TODO statt (siehe \ref{}) -> \cite{} nutzen
...
Bei der in dieser Arbeit entwickelten Implementierung handelt es sich um einen horizontalen Scanner (siehe \ref{Portscanning}).

...
% Mi: Chapter 7 beenden (Auf Wirtschaftlichkeit eingehen in Evaluation!)
% Do: Chapter 5 überarbeiten, Kleine Todos
% Fr: GitHub Repos anlegen, Referenzen setzen, Eigenständigkeitserklärung
% Sa: Formatierung

% Referenzen korrekt setzen -> Falls eine Referenz nicht gültig ist, oder TODO dran steht, Referenz am 
...
Das Scannen von Netzwerken oder gar dem gesamten Internet macht einen nicht zu vernachlässigenden Teil des Datenverkehrs im
...
Bekannte \eng{Open-Source}-Internetscanning-Projekte wie ZMap, welches über 10 Jahre stetig weiterentwickelt wurde \cite{Durumeric_Adrian_Stephens_Wustrow_Halderman_2024} oder Masscan \cite{Graham_2026} 
...
und weitere Techniken. Diese Sprachen sind allerdings im Vergleich zu Sprachen ohne automatischer Speicherverwaltung wie C weniger performant \cite{bugden2022safety}. 
...
werden in dieser Implementierung rudimentär behandelt, da der Fokus

...
oft Wochen oder Monate \cite{Durumeric_Wustrow_Halderman_182948}.
...
in unter 45 Minuten von einem einzelnen Rechner aus \cite{Durumeric_Wustrow_Halderman_182948}. Spätere Arbeiten, wie 
Zippier ZMap, optimierten diesen Ansatz weiter, um auch bis zu 10-Gbps-Leitungen auszulasten \cite{185139}
...
In der wissenschaftlichen Literatur gilt ZMap \cite{Durumeric_Wustrow_Halderman_182948} als der De-facto-Standard und als das primäre Vergleichsobjekt für 
...
\begin{itemize} 
    ...
    Zippier ZMap \cite{185139}, dass durch spezialisierte Treiber wie \texttt{PF\_RING ZC} (\eng{Zero-Copy}) 
    ...
    IPv4-Adressraums, was nötig ist, um Zielnetzwerke nicht zu überlasten. \cite{Durumeric_Wustrow_Halderman_182948}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Wissenschaftlicher Standard:} Als primäres Vergleichsobjekt dient ZMap \cite{Durumeric_Wustrow_Halderman_182948}, 

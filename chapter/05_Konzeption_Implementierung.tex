...
unterstützt die Implementierung sowohl \texttt{AF\_PACKET} als auch \texttt{AF\_XDP} als Sende-Backend. 
...
Prinzipien werden zudem \eng{Batching} und \eng{Zero-Copy}-Techniken angewandt (vgl. \cref{lst:parser_binary}). 

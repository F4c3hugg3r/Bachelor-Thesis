...
\usepackage[style=ieee, backend=biber,   natbib=true]{biblatex}  % Verarbeitung mit biber
...
\lstdefinelanguage{Rust}{
	keywords={true,false,auth,use,let,mut,if,else,fn,str,String,impl,struct,enum,match,mod,pub,crate,return,where,for,while,loop,break,continue,type,ref,self,super,extern,const,static,trait,unsafe,as,in},
	ndkeywords={u8,u16,u32,u64,i8,i16,i32,i64,f32,f64,bool,char,usize,isize,Option,Result,Self,Box,Vec,Rc,Arc,Cell,RefCell,HashMap,BTreeMap,HashSet,BTreeSet},
	sensitive=true,
	comment=[l]{//},
	morecomment=[s]{/*}{*/},
	morestring=[b]"

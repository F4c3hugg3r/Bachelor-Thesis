...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, calc, shapes.misc, decorations.pathmorphing}
\usepackage{bmpsize} 
...
% Eigene Bezeichner für cleveref
\crefname{test}{Evaluationstest}{Evaluationstests}
\Crefname{test}{Evaluationstest}{Evaluationstests}
\crefname{scenario}{Evaluationsszenario}{Evaluationsszenarien}
\Crefname{scenario}{Evaluationsszenario}{Evaluationsszenarien}
